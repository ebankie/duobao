...
class Alipay extends \Think\Pay\Pay {
	...
	//protected $notify_url = U('/Home/Pay/notify_url');
	protected $notify_url = "http://bcy.akng.net/Home/Pay/notify_url";
	//protected $return_url = U('/Home/Pay/return_url');
	protected $return_url = "http://bcy.akng.net/Home/Pay/return_url";
    protected $configs = array(
        'email' => 'liukang@ewangtx.com',
        'key' =>  'la5yweazhdive48mays5hy2qwbhwxwda',
        'partner' =>  '2088011370216232',
		'notify_url' =>  'http://bcy.akng.net/Home/Public/notify/apitype/alipay/method/notify',
		'return_url' =>  'http://bcy.akng.net/Home/Public/notify/apitype/alipay/method/return',
		//'notify_url' =>  'http://bcy.akng.net/Home/Public/notify',
		//'return_url' =>  'http://bcy.akng.net/Home/Public/notify',
    );
