...
<div id="main-content">
  ...
  <div id="main" class="main">
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <input type="hidden" class="text input-large" name="id" value="<?php echo I('get.id');?>">
        <div class="form-item">
            <label class="item-label">备注<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="remarks" value="<?php echo ($info["remarks"]); ?>">
            </div>
        </div>
        <div class="form-item">
